...
<form role="form" method="POST" action="controladores/ControladorPrincipal.php" id="formRegistro">
    <table>
        <fieldset>
            <tr>
                <td>
                    <input class="form-control" placeholder="Nombre_Cargo" name="rolNombre" type="text" pattern="" required="required" autofocus
                           value="<?php if (isset($erroresValidacion['datosViejos']['rolNombre'])) echo $erroresValidacion['datosViejos']['rolNombre'];  
                                                if (isset($_SESSION['rolNombre'])) echo $_SESSION['rolNombre']; unset($_SESSION['rolNombre']); ?>"
                           >
            ...
            <tr>
                <td>                
                    <input class="form-control" placeholder="Descripcion_Cargo" name="rolDescripcion" type="text"   required="required"
                           value="<?php if (isset($erroresValidacion['datosViejos']['rolDescripcion'])) echo $erroresValidacion['datosViejos']['rolDescripcion'];  
                                                if (isset($_SESSION['rolDescripcion'])) echo $_SESSION['rolDescripcion']; unset($_SESSION['rolDescripcion']); ?>"
                           >
            ...
            <tr>
                <td>                  
                    <input class="form-control" placeholder="Estado_Cargo" name="rolEstado" type="number"  required="required"
                           value="<?php if (isset($erroresValidacion['datosViejos']['rolEstado'])) echo $erroresValidacion['datosViejos']['rolEstado']; 
                                                if (isset($_SESSION['rolEstado'])) echo $_SESSION['rolEstado']; unset($_SESSION['rolEstado']); ?>"
                           >
            ...
            <input type="hidden" name="ruta" value="insertarCargo">
            <!--<input type="hidden" name="contenido" value="controlarRegistro">-->
            <tr>
                <td>            
                    <button  onclick="valida_registro()">Agregar Cargo</button>
                </td>
            </tr>             
    </table>
</form>
