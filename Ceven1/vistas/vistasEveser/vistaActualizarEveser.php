...
if (isset($_SESSION['actualizarDatosEveser'])) {
    $actualizarDatosEveser = $_SESSION['actualizarDatosEveser'];
    unset($_SESSION['actualizarEveser']);
}
...
<form role="form" method="POST" action="controladores/ControladorPrincipal.php" id="formRegistro">
    <table>
        <fieldset>
            <tr>
                <td>
                    <input class="form-control" placeholder="Id_Evento" name="Eventos_eveId" type="number" pattern="" required="required" autofocus readonly="readonly"
                           value="<?php
                           if (isset($actualizarDatosEveser->Eventos_eveId))
                               echo $actualizarDatosEveser->Eventos_eveId;
            ...
            <tr>
                <td>                
                    <input class="form-control" placeholder="Documento_Cliente" name="Eventos_Clientes_cliDocumento" type="number"   required="required"
                           value="<?php
                           if (isset($actualizarDatosEveser->Eventos_Clientes_cliDocumento))
                               echo $actualizarDatosEveser->Eventos_Clientes_cliDocumento;                           
                           if (isset($erroresValidacion['datosViejos']['Eventos_Clientes_cliDocumento']))
                               echo $erroresValidacion['datosViejos']['Eventos_Clientes_cliDocumento'];
                           if (isset($_SESSION['Eventos_Clientes_cliDocumento']))
                               echo $_SESSION['Eventos_Clientes_cliDocumento'];
                           unset($_SESSION['Eventos_Clientes_cliDocumento']);
                           ?>">
            ...
            <tr>
                <td>                  
                    <input class="form-control" placeholder="Id_Servicio" name="Servicios_serId" type="number"  required="required"
                           value="<?php
                           if (isset($actualizarDatosEveser->Servicios_serId))
                               echo $actualizarDatosEveser->Servicios_serId;                            
                           if (isset($erroresValidacion['datosViejos']['Servicios_serId']))
                               echo $erroresValidacion['datosViejos']['Servicios_serId'];
                           if (isset($_SESSION['Servicios_serId']))
                               echo $_SESSION['Servicios_serId'];
                           unset($_SESSION['Servicios_serId']);
                           ?>">
            ...
            <tr>
                <td>                  
                    <input class="form-control" placeholder="Estado_Evento" name="evsEstado" type="number"  required="required"
                           value="<?php
                           if (isset($actualizarDatosEveser->evsEstado))
                               echo $actualizarDatosEveser->evsEstado;                            
                           if (isset($erroresValidacion['datosViejos']['evsEstado']))
                               echo $erroresValidacion['datosViejos']['evsEstado'];
                           if (isset($_SESSION['evsEstado']))
                               echo $_SESSION['evsEstado'];
                           unset($_SESSION['evsEstado']);
                           ?>">
            ...
            <input type="hidden" name="ruta" value="confirmaActualizarEveser">
