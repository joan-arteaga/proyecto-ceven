...
<head>
  ...
  <title>Administrador_Configuración</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Configuraciones de cuenta</li>
      </ol>
      <h1>Fondo</h1>
      <hr>
      ...
      <p>Aqui podras definir la forma en la que mas te guste manejar tu espacio de trabajo <u><strong>Ceven.</strong></u>
      Si tienes mas sujerencias comunicate con nosotros atravez del correo <u style="color:lightblue">ceven.c.2018@gmail.com</u><br>Recuerda que CEVEN quiere lo mejor para ti...</p><br>
      <a class="btn btn-primary" href="#" id="toggleNavColor" data-toggle="tooltip" title="claro/oscuro">Cambiar color de ambiente</a><br><br>
      <a class="btn btn-primary" href="#" id="toggleNavPosition" data-toggle="tooltip" title="arriba/abajo">Posición fija de navegacion/Posición estatica de navegacion</a>
